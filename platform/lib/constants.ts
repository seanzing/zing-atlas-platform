...
export const NAV_ITEMS = [
  ...
  { key: "deals", label: "All Deals", icon: "M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z", href: "/deals" },
  { key: "team", label: "Team", icon: "M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z", href: "/team" },
  ...
  { key: "products", label: "Products", icon: "M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4", href: "/products" },
  { key: "marketing", label: "Marketing", icon: "M11 5.882V19.24a1.76 1.76 0 01-3.417.592l-2.147-6.15M18 13a3 3 0 100-6M5.436 13.683A4.001 4.001 0 017 6h1.832c4.1 0 7.625-1.952 9.168-5v14c-1.543-3.048-5.068-5-9.168-5H7a3.988 3.988 0 01-1.564-.317z", href: "/marketing" },
...
export const COMPONENT_LIBRARY = {
  ...
  social_1:           { name: 'Social Media 1 Post/Week · 2 Weeks',    taskType: 'social_media',    ownerRole: 'marketing',             daysOffset: 14,  statusOptions: SOCIAL_MEDIA_STATUS_OPTIONS },
  social_2:           { name: 'Social Media 2 Posts/Week · 2 Weeks',   taskType: 'social_media',    ownerRole: 'marketing',             daysOffset: 14,  statusOptions: SOCIAL_MEDIA_STATUS_OPTIONS },
  social_1_3mo:       { name: 'Social Media 1 Post/Week · 3 Months',   taskType: 'social_media',    ownerRole: 'marketing',             daysOffset: 90,  statusOptions: SOCIAL_MEDIA_STATUS_OPTIONS },
  social_1_6mo:       { name: 'Social Media 1 Post/Week · 6 Months',   taskType: 'social_media',    ownerRole: 'marketing',             daysOffset: 180, statusOptions: SOCIAL_MEDIA_STATUS_OPTIONS },
  social_1_12mo:      { name: 'Social Media 1 Post/Week · 12 Months',  taskType: 'social_media',    ownerRole: 'marketing',             daysOffset: 365, statusOptions: SOCIAL_MEDIA_STATUS_OPTIONS },
...
export const COMPONENT_GROUPS: { label: string; keys: ComponentKey[] }[] = [
  ...
  { label: 'Content',    keys: ['ai_chat', 'social_1', 'social_2', 'social_1_3mo', 'social_1_6mo', 'social_1_12mo'] },
